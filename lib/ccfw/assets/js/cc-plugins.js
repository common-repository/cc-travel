...
(function ($) {
	...
	$.extend(Rule.prototype, {
		...
		evalCondition: function (context, control, condition, val1, val2) {
			 ...
			 *
			 * CCTheme Framework
			 * Added new condition for CCTheme Framework
			 *
			 * @since 1.0.0
			 * @version 1.0.0
			 *
...
+function ($) {
	...
	var CCTooltip = function (element, options) {
		...
		this.init('cctooltip', element, options)
	}
		...
		if (this.hasContent() && this.enabled) {
			...
			$.support.transition && this.$tip.hasClass('fade') ?
				$tip
					...
					.CSemulateTransitionEnd(CCTooltip.TRANSITION_DURATION) :
				complete()
		}
	}
	...
	function Plugin(option) {
		return this.each(function () {
			var $this = $(this)
			var data = $this.data('bs.cctooltip')
			var options = typeof option == 'object' && option

			if (!data && /destroy|hide/.test(option)) return
			if (!data) $this.data('bs.cctooltip', (data = new CCTooltip(this, options)))
			if (typeof option == 'string') data[option]()
		})
	}

	var old = $.fn.cctooltip

	$.fn.cctooltip = Plugin
	$.fn.cctooltip.Constructor = CCTooltip


	// TOOLTIP NO CONFLICT
	// ===================

	$.fn.cctooltip.noConflict = function () {
		$.fn.cctooltip = old
		return this
	}
